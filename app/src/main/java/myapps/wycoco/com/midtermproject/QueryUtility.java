...
public class QueryUtility {
    ...
    public static ArrayList<ArticlesModel> fetchNewsData(String requestUrl){
        ...
        ArrayList<ArticlesModel> newsArticles = extractFeatureFromJson(jsonResponse);
        return newsArticles;
    }
    ...
    private static ArrayList<ArticlesModel> extractFeatureFromJson(String newsJson){
        ...
        try{
            ...
            for(int i = 0 ; i<newsArray.length(); i++){
                ...
                ArticlesModel article = new ArticlesModel(author,title,description,url,urlToImage,publishedAt);
